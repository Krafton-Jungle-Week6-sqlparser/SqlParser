...
- 데이터베이스 엔진 전체를 구현하기보다, 간단한 SQL이 처리되는 흐름을 처음부터 끝까지 직접 만들어보는 데 집중했습니다.
...
- 전체 코드를 한 번에 보지 않고, 단계별로 나눠 학습할 수 있어 학습 효율이 높아졌습니다.
- 팀 전체 속도를 맞춰 안정적으로 마지막 단계까지 진행할 수 있었습니다.
